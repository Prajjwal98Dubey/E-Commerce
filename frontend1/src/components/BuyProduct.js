    ...
    <>
     ...
     <div className='ml-[350px] mb-[50px] w-[550px] h-[230px] border border-gray-300 rounded-lg font-Poppins'>
       ...
       <div className='flex flex-col items-center mt-2 ml-5'> 
         <Link to={'/checkout?v='+product.id}><button className='w-[200px] h-[35px] rounded-lg bg-green-600 text-white hover:bg-green-800'>Pay ₹{((product.price) * 81).toLocaleString()}.00 </button></Link>
       </div>
     </div>
     </>
    }
