...
const AboutUs = () => {
  return (
    ...
    <Link to='/home'><button className='bg-blue-600 ml-[530px] w-[210px] shadow-xl pl-5 text-center rounded-lg p-2 mt-24 mb-[250px] font-Poppins text-white text-2xl hover:bg-black hover:shadow-green-600 h-fit'>Explore🚀</button></Link>
    </div>
    <Footer/>
    </>
  )
