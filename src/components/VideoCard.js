...
const VideoCard = ({ products }) => {
    return (
        <>
          ...
          <div className='w-96 h-[350px] rounded-lg mx-4 my-2 border border-white hover:shadow-lg hover:border border-gray-400 cursor-pointer'>
                ...
                <ul className='flex justify-around'>
                  <li className='border border-gray-400 bg-gray-400 rounded-lg text-white text-[14px] w-[60px] text-center'>₹{(products.price)*81}</li>
