...
const Carrer = () => {
  ...
  return (
    ...
    <div className='flex flex-col items-center justify-center p-4 font-Poppins mt-24'>
      ...
      <div className='text-2xl mb-5'>Currently only <Link to='https://github.com/Prajjwal98Dubey' target='_blank'><span className='text-4xl font-bold text-green-600 font-Poppins animate-pulse'>'I'</span></Link> am working</div>
