  ...
  return (
    ...
    <Navbar/>
     <div className='flex mt-5 animate-pulse'>
      <div>
        <div className=' ml-2 mt-2 w-[550px] h-[400px] bg-gray-300'>
        </div>
        <div className='flex mt-2 p-1 mb-2 ml-9'>
        <div className='w-[115px] h-[50px] mr-2 bg-gray-300'></div>
        <div className='w-[115px] h-[50px] bg-gray-300'></div>
        </div>
