    ...
    <>
      <div className='flex flex-col items-center sticky top-0'>
        <ul className='flex w-full font-Poppins justify-around font-semibold bg-green-500 h-[56px] p-2'>
          ...
          <Link to='/AddToCart'><li className=' ml-6 text-2xl w-fit '><div className='flex w-[200px] h-[100px]'> 
    <div><img className='w-[55px] h-[35px] mt-1' src={CART_IMG} alt="loading"/></div>
